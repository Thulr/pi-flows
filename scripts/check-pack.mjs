...
// Raised to 1_165_000 for the strict-trace structural gate: trace-scope gains
...
// measured 1_164_535, matching the previous raise.
assert.ok(pack.unpackedSize < 1_165_000, `package unpacked size too large: ${pack.unpackedSize}`);
