...
// Raised to 1_276_700 for #142 (Handoffs exist only at a crossed role boundary):
...
// the file set stays 109 and headroom is ~500 B over measured 1_276_192.
assert.ok(pack.unpackedSize < 1_276_700, `package unpacked size too large: ${pack.unpackedSize}`);
