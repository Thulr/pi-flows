...
// Raised to 1_163_900 for the strict-trace structural gate: trace-scope gains
...
// measured 1_163_435, matching the previous raise.
assert.ok(pack.unpackedSize < 1_163_900, `package unpacked size too large: ${pack.unpackedSize}`);
