...
// Raised to 1_165_500 for the strict-trace structural gate: trace-scope gains
...
// measured 1_165_035, matching the previous raise.
assert.ok(pack.unpackedSize < 1_165_500, `package unpacked size too large: ${pack.unpackedSize}`);
