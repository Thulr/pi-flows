...
// Raised to 1_162_560 for the strict-trace structural gate: trace-scope gains
...
// measured 1_162_091, matching the previous raise.
assert.ok(pack.unpackedSize < 1_162_560, `package unpacked size too large: ${pack.unpackedSize}`);
