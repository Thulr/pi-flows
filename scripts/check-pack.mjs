...
// Raised to 1_169_350 for the strict-trace structural gate: trace-scope gains
...
// measured 1_168_885, matching the previous raise.
assert.ok(pack.unpackedSize < 1_169_350, `package unpacked size too large: ${pack.unpackedSize}`);
