...
// Raised to 1_168_800 for the strict-trace structural gate: trace-scope gains
...
// measured 1_168_317, matching the previous raise.
assert.ok(pack.unpackedSize < 1_168_800, `package unpacked size too large: ${pack.unpackedSize}`);
