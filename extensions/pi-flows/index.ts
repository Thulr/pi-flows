...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"When a flow returns retryable:false, treat the unchanged call as terminal. For BUDGET_EXCEEDED, do not automatically replay the same work: ask the user for direction or make a material, visible change to the owning budget, task, or fan-out before starting another Flow.",
