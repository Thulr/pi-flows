...
- Trace tests: `tests/trace-topology.test.ts` (span roles, stage nesting, dependency links) and `tests/trace-evidence.test.ts` (identity attributes, capture policy, handoff accounting, trace health, strict mode)
